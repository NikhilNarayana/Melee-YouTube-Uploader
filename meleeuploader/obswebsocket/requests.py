...
# (Generated on 2021-09-28 17:49:21.181124) #
...
class ExecuteBatch(Baserequests):
    ...
    def __init__(self, requests, abortOnFail):
        ...
        self.dataout['requests'] = requests
        self.dataout['abortOnFail'] = abortOnFail

    def getResults(self):
        return self.datain['results']
...
class Sleep(Baserequests):
    ...
    def __init__(self, sleepMillis):
        Baserequests.__init__(self)
        self.name = 'Sleep'
        self.dataout['sleepMillis'] = sleepMillis
...
class SetAudioTracks(Baserequests):
    ...
    def __init__(self, sourceName, track, active):
        ...
        self.dataout['sourceName'] = sourceName
        self.dataout['track'] = track
        self.dataout['active'] = active
...
class GetAudioTracks(Baserequests):
    ...
    def getTrack1(self):
        return self.datain['track1']

    def getTrack2(self):
        return self.datain['track2']

    def getTrack3(self):
        return self.datain['track3']

    def getTrack4(self):
        return self.datain['track4']

    def getTrack5(self):
        return self.datain['track5']

    def getTrack6(self):
        return self.datain['track6']
...
class GetSourceActive(Baserequests):
    ...
    def getSourceActive(self):
        return self.datain['sourceActive']
...
class GetSourceDefaultSettings(Baserequests):
    ...
    def getDefaultSettings(self):
        return self.datain['defaultSettings']
...
class GetStreamingStatus(Baserequests):
    ...
    def getRecordingPaused(self):
        return self.datain['recording-paused']
    ...
    def getVirtualcamTimecode(self):
        return self.datain['virtualcam-timecode']
...
class GetVirtualCamStatus(Baserequests):
    ...
    def getIsVirtualCam(self):
        return self.datain['isVirtualCam']

    def getVirtualCamTimecode(self):
        return self.datain['virtualCamTimecode']
